...
INSERT INTO SALES (ORDER_ID, ORDER_DATE, CUSTOMER_ID ,PRODUCT_ID ,PROFIT) VALUES (26, TO_DATE('2024-02-26', 'YYYY-MM-DD'), 25, 'P026', 250.89);
COMMIT;
...
INSERT INTO CUSTOMER (CUSTOMER_ID, CUSTOMER_NAME,  SEGMEMT,CITY) VALUES  (26, 'Aria Lee', 'Retail','Nashville');
COMMIT;
...
INSERT INTO PRODUCT(PRODUCT_ID,  PRODUCT_NAME, PRODUCT_QUANTITY, PRODUCT_PRICE0 VALUES  ('P026', 'Cordless Vaccum Cleaner' ,12,129.99);
